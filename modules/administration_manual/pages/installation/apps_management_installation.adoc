...
To install an app manually instead of by using {marketplace-url}[the Marketplace], copy the app either into ownCloud's default app folder (`</path/to/owncloud>/apps`) or a custom app folder <using_custom_app_directories_label>.
